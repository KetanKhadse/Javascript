...
//some examples
//primitive
let Name = "Ketan Khadse";
let Age = 26;
let isStudent = true;
let Password = Symbol('123');
let NewPassword = Symbol('123');
let Number = 1234211234311234321234333333333134123n; //n at the back of a big number makes it bigint
console.log(Password === NewPassword);

//Referance types 
const Arr = ["Jack","Ram","Shyam"];
...
var Func = function Simple(){
    console.log("This is a funvtion");
}
